...
public class TopRated extends Fragment implements ItemClick {
    private static final String TAG = "TopRated";
    private List<Movies> mMoviesArrayList;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if(NetworkUtils.isConnected(getContext())){
            ...
            setUpTopratedMoviesViewModel();
        }else{
            Toast.makeText(getContext(),R.string.connection_timeout,Toast.LENGTH_LONG).show();
        }
    ...
    private void setUpTopratedMoviesViewModel() {
        MainActivityViewModel mainActivityViewModel = new ViewModelProvider(this).get(MainActivityViewModel.class);
        mainActivityViewModel.getTopratedMoviesResponse().observe(getViewLifecycleOwner(), new Observer<MovieResponse>() {
            @Override
            public void onChanged(MovieResponse movieResponse) {
                if(movieResponse!=null){
                    mMoviesArrayList=movieResponse.getResults();
                    movieResponse.setResults(mMoviesArrayList);
                    mMoviesAdapter=new MoviesAdapter(getContext(),mMoviesArrayList,TopRated.this::onItemClicked);
    ...
    public void onItemClicked(Movies movies) {
        ...
        data.putString("VOTE_AVERAGE",getString(R.string.rating)+movies.getVote_average());
        data.putString("RELEASE_DATE",getString(R.string.release_date)+movies.getRelease_date());
